<?php
    ...
    defined('CONSUMER_KEY') || define('CONSUMER_KEY', 'Your keys'); //Add your twitter consumer key
    defined('CONSUMER_SECRET') || define('CONSUMER_SECRET', 'Your keys'); //Add twitter consumer secret key
    defined('TWITTER_ACCESS_TOKEN') || define('TWITTER_ACCESS_TOKEN', 'Your keys'); //Add twitter access token 
    defined('TWITTER_ACCESS_TOKEN_SECRET') || define('TWITTER_ACCESS_TOKEN_SECRET', 'Your keys'); //Add twitter access token secret
