<?php
    ...
    <title><?php echo SITE_NAME; ?></title>
          ...
          <?php include './js/jsfunctiont_twi.php'; ?>
    </head>
    <body>
                ...
                <div style="top: 0px; left: 0px; width: 100%; height: 100%;">
                    <div style="height:auto; width:900px; margin: 50px auto;">
                       ...
                       <div class="header-content">
                            ...
                            <?php include './css/downcss.php'; ?>


                        <form allign:"center" id="down_follow_data">
                            <div class="header-right-content">
                     <label>Enter user handler:<p style="color:red">Without '@'</p></label><input id="txtflwdwn" required type="text" placeholder="Enter screen name here" autocomplete="off">

                     <p style="color:red" id="demo"></p>
                         
                     <label>Select Format:</label>  
                            <select id="dropbox" name="download_format" required>
                                <option value="">--- Select Format ---</option>
                                <option value="csv">CSV format</option>
                                <option value="pdf">PDF format</option>
                                                           
                            </select>
                            <button class="btn" id="flwdwnbtn" type="button"  onclick="tmp();" style="width:100%"><i class="fa fa-download"></i> Download</button>
